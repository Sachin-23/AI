        ...
        for sentence in self.knowledge:
            if sentence.cells & new_sentence.cells:
                if sentence.cells.issubset(new_sentence.cells):
                    inference_sentences.append(Sentence(new_sentence.cells - sentence.cells, new_sentence.count - sentence.count))
                elif new_sentence.cells.issubset(sentence.cells):
                    inference_sentences.append(Sentence(sentence.cells - new_sentence.cells, sentence.count - new_sentence.count))
        if inference_sentences:
            self.knowledge += inference_sentences
